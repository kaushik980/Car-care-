    ...
    <div className="bg-purple-300 p-10">
      <div className="min-w-screen mx-auto bg-white shadow-lg rounded-md p-6 border">
        ...
        <div className="flex justify-between items-start mt-4">
          ...
          <button
  onClick={() => navigate("/wannasell")} // Wrap navigate in an arrow function
  className="mt-2 bg-indigo-500 text-white py-2 px-4 rounded-xl hover:bg-indigo-600"
>
  Make Offer
</button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm text-gray-700">
            <div className="">
              <p className="text-2xl">
                ...
                <span className="font-medium">{car.yearOfManufacturing}</span>
              </p>
              <p className="text-2xl">
              ...
              <p className="text-2xl">
                Reg. City:{" "}
                <span className="font-medium">{car.regCity}</span>
              </p>
              <p className="text-2xl">
                Insurance Type:{" "}
                <span className="font-medium">{car.insuranceType}</span>
              </p>
              <p className="text-2xl">
                Road Tax Validity:{" "}
                <span className="font-medium">{car.roadTaxDateValidity}</span>
              </p>
            </div>
            <div>
              <p className="text-2xl">
                CNG/LPG Fitment:{" "}
                <span className="font-medium">{car.cngFitmentInRc}</span>
              </p>
              <p className="text-2xl">
                Reg. Number:{" "}
